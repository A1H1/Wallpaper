...
import com.kingdov.goldwallpapers.func.Button;
import com.kingdov.goldwallpapers.func.CustomTextView;

import static com.kingdov.goldwallpapers.config.admob.initialInterstitial;
import static com.kingdov.goldwallpapers.config.admob.showInterstitial;
...
public class WallpaperDetail extends AppCompatActivity {
    ...
    private void setData() {
        wallstufftitle.setText(sData.title);
        wallstuffsite.setText(sData.title);
        wallstufflink.setText(sData.url);
        wallstuffsize.setText("Type");
        switch (sData.url.toLowerCase().substring(sData.url.length() - 3)){
            case "jpg" :
        ...
        if (sData.title.matches("Pinimg") || sData.title.matches("Imgur")) {
    ...
    private void setDownload(String uRl) {
        ...
        fileplace = Environment.getExternalStorageDirectory() + directory + sData.title + extension;
                                ...
                                Snackbar.make(apnaview, "Download Finished", Snackbar.LENGTH_LONG)
                                        ...
                                        .setAction("Open", new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                intent.setDataAndType(Uri.parse("file://" + Environment.getExternalStorageDirectory() + directory + "/" + sData.title + extension), "image/*");
                                                startActivity(intent);
                                            }
                                        })
                                        .show();
